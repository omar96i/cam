...
<script>
    ...
    function load_factura(valor , pagina) {
        ...
        $.ajax({
            url      : '<?= base_url('talento_humano/home/getfacturas') ?>',
            method   : 'POST',
                    ...
                    for(var k=0; k<r.data.length; k++) {
                        tbody += `<tr>
                            ...
                            <td class="align-middle">
                                <a href="<?php echo site_url('talento_humano/Home/verRegistrosFactura/') ?>${r.data[k]['id_factura']}" class="text-dark"><img src="<?php echo base_url('assets/iconos_menu/verificar.png') ?>" alt=""></a>
                            </td>
                            </tr>`;
                    }
