								...
								<table id="empty" class="table table-sm table-striped table-bordered">
									...
									<tbody>
										...
										<tr>
											...
											<td colspan="7" class="text-right" style="font-size: 1.2em;"><?php if($consulta1[0]->tipo_cuenta == "tecnico sistemas"){ echo "SUPERVISOR"; }else{ echo $consulta1[0]->tipo_cuenta; } ?></td>
										</tr>
									</tbody>
								</table>
							</div>
							    <div  class="table-responsive mt-1">
							        <table id="empty" class="table table-sm table-striped table-bordered">
							            ...
							            <tbody class="text-center">	
                                            <tr>
                                                <td><?php echo $consulta1[0]->estado_meta; ?></td>
                                                <td><?php echo $consulta1[0]->cant_horas; ?></td>
                                                <td><?php echo $consulta1[0]->descuento; ?></td>
                                                <td><?php echo $consulta1[0]->comision; ?></td>
                                                <td><?php echo "$ ".number_format(($consulta1[0]->nuevo_valor == null)?$consulta1[0]->total_paga : $consulta1[0]->nuevo_valor); ?></td>
                                            </tr>
							            </tbody>
							        </table>
							    </div>
