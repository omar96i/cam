                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="row">
                                    <div class="col-8">
                                        <h2 class="d-inline">Agregar Reportes</h2>
                                    </div>
                                </div>
...
<script>
    $(document).ready(function() {
        ...
        $('.btn_agregar_reporte').on('click' , function(e){
            e.preventDefault();
            var ruta      = "<?php echo base_url('tecnico_sistemas/AddReportes/addReporte') ?>";
                ...
                if( $("#descripcion").val() != '' &&
                    ...
                    $.ajax({
                        ...
                        type: 'POST',
                        dataType: 'json',
                        data: {descripcion: descripcion, fecha: fecha},
                    })
                    .done(function(r) {
                        if(r.status){
                            $('#form_addproduct').trigger('reset');
                            alertify.notify('Reporte Registrado', 'success', 2);
                            return;
                        }
