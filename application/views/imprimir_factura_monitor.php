								...
								<table id="empty" class="table table-sm table-striped table-bordered">
									...
									<tbody>
										...
										<tr>
											...
											<td colspan="7" class="text-right" style="font-size: 1.2em;"><?php if($consulta1[0]->tipo_cuenta == "supervisor"){ echo "MONITOR"; }else{ echo $consulta1[0]->tipo_cuenta; } ?></td>
										</tr>
									</tbody>
								</table>
							</div>
							        ...
							        <table id="empty" class="table table-sm table-striped table-bordered">
							            ...
							            <tbody class="text-center">	
                                            <tr>
                                                ...
                                                <td><?php echo $consulta1[0]->total_comision; ?></td>
