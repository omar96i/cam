<div class="content-wrapper">
    ...
    <div class="content-header mt-1 mr-3"> 
        <div class="row">
            <div class="col-md-12">
                <a href="<?= base_url('admin/FacturaMonitor') ?>" class="btn btn-info float-right">Retroceder</a>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div>
    <!-- /page header -->
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-sm-12 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="id" value="<?php echo $factura[0]->id; ?>" class="form-control" readonly name="id">
...
<script>
    $(document).ready(function() {
        ...
        $('.btn_agregar_asignacion').on('click' , function(e){
            e.preventDefault();
            var ruta      = "<?php echo base_url('admin/home/editFacturaSupervisor') ?>";
                ...
                .done(function(r) {
                    ...
                    if(r.status){
                        ...
                        alertify.notify('Registro agregado con éxito', 'success', 2, function(){
                           window.location.href = '../../FacturaMonitor';
                        });
                        return;
                    }
