                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="row">
                                    <div class="col-6">
                                        <h2 class="d-inline">Nomina Monitor</h2>
...
<script>
    $(document).ready(function() {
        ...
        $(".btn_buscar_por_fechas").click(function(event){
			...
			ruta = "<?php echo base_url('admin/home/factura_supervisor/') ?>"+fecha_inicial+"/"+fecha_final
			window.location.href = ruta;
		});
		$(".btn_resetear").click(function(event){
			event.preventDefault();
			ruta = "<?php echo base_url('admin/home/factura_supervisor') ?>"
			window.location.href = ruta;
		});
    });
    function load_factura(valor , pagina) {
        ...
        $.ajax({
            url      : '<?= base_url('admin/Home/getfacturasSupervisor') ?>',
            method   : 'POST',
    ...
    $('body').on('click' , '.btn_generar_factura' , function(e){
        ...
        ruta = "<?php echo base_url('admin/Home/registrarFacturasEmpleados'); ?>";
            ...
            .done(function(r) {
                ...
                if(r.status){
                    ...
                    alertify.notify('Registro exitoso!', 'success', 2, function(){
                        window.location.href = '<?php echo base_url('admin/Home/factura_supervisor') ?>';
                    });
                    return;
                }
