                            ...
                            <div class="col-sm-12">
								...
								<div class="row mb-3">
									<div class="col-12 text-center">
										<a href="<?php echo base_url('admin/Home/metasSupervisor/general') ?>" class="btn <?php echo ($tittle == "general")? "btn-success": "btn-info"; ?> mb-2 ml-1">General</a>
										<a href="<?php echo base_url('admin/Home/metasSupervisor/registrado') ?>" class="btn <?php echo ($tittle == "registrado")? "btn-success": "btn-info"; ?> mb-2 ml-1">Registradas</a>
									</div>
								</div>
