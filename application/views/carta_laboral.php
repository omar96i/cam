				...
				<div class="card">
					...
					<div class="container">
						...
						<p style="font-size: 1.4em;">
							...
							<?php echo $consulta1[0]->created_at ?> desempeñándose como <?php if($consulta1[0]->tipo_cuenta == "empleado"){ echo "modelo"; }else{ echo $consulta1[0]->tipo_cuenta; } ?>, con un salario básico 
							de______________. ($ ____________). <br><br>
